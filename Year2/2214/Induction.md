...
![InequalityExample](assets/Induction/InequalityExample.jpeg)

Prove that $1.2+2.3+3.4+...+n(n+1)=\frac{n(n+1)(n+2)}{3}$

![DecimalExample](assets/Induction/DecimalExample.jpeg)
...
Given $n\in \mathbb{N}$, define $a_n$ recursively as follows:

$$ a_0=1, \ a_1=3,\ a_n=2a_{n-1}-a_{n-2}\text{ for }n\ge 2 $$

Prove that for all $n\ge 0,\ a_n=2n+1$

![StrongInductionExample](assets/Induction/StrongInductionExample.jpeg)